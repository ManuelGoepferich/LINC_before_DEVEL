...
```{r fig.width = 14, fig.height = 12, warning = F, message = F, eval =T}
...
```{r fig.width = 9.5, fig.height = 11.5, fig.keep='first', warning = F, eval =T}
...
```{r fig.width = 17, fig.height = 10, warning = F, eval =T}
data(BRAIN_EXPR)
...
```{r fig.width = 11.5, fig.height = 5, warning = F, fig.keep='none', eval =T}
...
```{r fig.width = 10, fig.height = 5.5, warning = F, eval =T}
...
```{r fig.width = 9, fig.height = 7.5, fig.keep='first', warning = F, message = F, eval =T}
...
```{r fig.width = 11, fig.height = 7, warning = F, eval =T}
data(BRAIN_EXPR)
class(crbl_matrix)
