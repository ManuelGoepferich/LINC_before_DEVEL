...
```{r fig.width = 14, fig.height = 12, warning = FALSE, message = FALSE, eval = TRUE}
...
```{r fig.width = 9.5, fig.height = 11.5, fig.keep='first', warning = FALSE, eval = TRUE}
...
```{r fig.width = 21, fig.height = 10, warning = FALSE, eval = TRUE}
