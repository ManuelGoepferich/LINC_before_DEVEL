...
```{r fig.width = 17, fig.height = 10, warning = F}
data(BRAIN_EXPR)
...
```{r fig.width = 11.5, fig.height = 5, warning = F, fig.keep='none'}
...
```{r fig.width = 10, fig.height = 5.5, warning = F}
...
```{r fig.width = 9, fig.height = 7.5, fig.keep='first', warning = F, message = F}
...
[9] Yu G. ReactomePA: Reactome Pathway Analysis. R package version 1.12.1.
